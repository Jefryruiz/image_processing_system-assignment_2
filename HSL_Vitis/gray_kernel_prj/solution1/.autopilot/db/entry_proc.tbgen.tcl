...
set Spec2ImplPortList { 
	...
	out_r_c { ap_fifo {  { out_r_c_din fifo_data_in 1 64 }  { out_r_c_num_data_valid fifo_status_num_data_valid 0 3 }  { out_r_c_fifo_cap fifo_update 0 3 }  { out_r_c_full_n fifo_status 0 1 }  { out_r_c_write fifo_port_we 1 1 } } }
}
