...
set C_modelName {proc_stage}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ stream_in int 24 regular {fifo 0 volatile }  }
	{ stream_out int 8 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_in", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "stream_out", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ stream_in_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ stream_in_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ stream_in_empty_n sc_in sc_logic 1 signal 0 } 
	{ stream_in_read sc_out sc_logic 1 signal 0 } 
	{ stream_out_din sc_out sc_lv 8 signal 1 } 
	{ stream_out_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ stream_out_fifo_cap sc_in sc_lv 9 signal 1 } 
	{ stream_out_full_n sc_in sc_logic 1 signal 1 } 
	{ stream_out_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "stream_out", "role": "din" }} , 
 	{ "name": "stream_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "stream_out", "role": "num_data_valid" }} , 
 	{ "name": "stream_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "stream_out", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "stream_in", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50", "Port" : "stream_in", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "stream_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50", "Port" : "stream_out", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50", "Parent" : "0", "Child" : ["2", "3", "4", "5"],
		"CDFG" : "proc_stage_Pipeline_VITIS_LOOP_24_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50.mul_8ns_10ns_17_1_1_U12", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50.mac_muladd_8ns_7ns_17ns_17_4_1_U13", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50.mac_muladd_10ns_8ns_17ns_18_4_1_U14", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_proc_stage_Pipeline_VITIS_LOOP_24_1_fu_50.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}


set ArgLastReadFirstWriteLatency {
	proc_stage {
		stream_in {Type I LastRead 1 FirstWrite -1}
		stream_out {Type O LastRead -1 FirstWrite 5}
		num_pixels {Type I LastRead 0 FirstWrite -1}
		num_pixels_c {Type O LastRead -1 FirstWrite 0}}
	proc_stage_Pipeline_VITIS_LOOP_24_1 {
...
set Spec2ImplPortList { 
	stream_in { ap_fifo {  { stream_in_dout fifo_data_in 0 24 }  { stream_in_num_data_valid fifo_status_num_data_valid 0 9 }  { stream_in_fifo_cap fifo_update 0 9 }  { stream_in_empty_n fifo_status 0 1 }  { stream_in_read fifo_port_we 1 1 } } }
	stream_out { ap_fifo {  { stream_out_din fifo_data_in 1 8 }  { stream_out_num_data_valid fifo_status_num_data_valid 0 9 }  { stream_out_fifo_cap fifo_update 0 9 }  { stream_out_full_n fifo_status 0 1 }  { stream_out_write fifo_port_we 1 1 } } }
