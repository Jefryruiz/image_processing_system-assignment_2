...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "out_r", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "stream_out", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_out_dout sc_in sc_lv 8 signal 2 } 
	{ stream_out_num_data_valid sc_in sc_lv 9 signal 2 } 
	{ stream_out_fifo_cap sc_in sc_lv 9 signal 2 } 
	{ stream_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ stream_out_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "stream_out", "role": "dout" }} , 
 	...
 	{ "name": "stream_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out", "role": "empty_n" }} , 
 	{ "name": "stream_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_stage_Pipeline_VITIS_LOOP_38_1_fu_69", "Port" : "gmem", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "stream_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_stage_Pipeline_VITIS_LOOP_38_1_fu_69", "Port" : "stream_out", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_stage_Pipeline_VITIS_LOOP_38_1_fu_69", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "write_stage_Pipeline_VITIS_LOOP_38_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_stage_Pipeline_VITIS_LOOP_38_1_fu_69.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	write_stage_Pipeline_VITIS_LOOP_38_1 {
...
set Spec2ImplPortList { 
	...
	out_r { ap_fifo {  { out_r_dout fifo_data_in 0 64 }  { out_r_num_data_valid fifo_status_num_data_valid 0 3 }  { out_r_fifo_cap fifo_update 0 3 }  { out_r_empty_n fifo_status 0 1 }  { out_r_read fifo_port_we 1 1 } } }
	stream_out { ap_fifo {  { stream_out_dout fifo_data_in 0 8 }  { stream_out_num_data_valid fifo_status_num_data_valid 0 9 }  { stream_out_fifo_cap fifo_update 0 9 }  { stream_out_empty_n fifo_status 0 1 }  { stream_out_read fifo_port_we 1 1 } } }
