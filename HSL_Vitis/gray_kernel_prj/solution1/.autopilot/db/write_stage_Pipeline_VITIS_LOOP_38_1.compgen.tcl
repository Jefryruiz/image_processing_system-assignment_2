...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_dout { I 8 vector } stream_out_num_data_valid { I 9 vector } stream_out_fifo_cap { I 9 vector } stream_out_empty_n { I 1 bit } stream_out_read { O 1 bit } } \
} "
}
