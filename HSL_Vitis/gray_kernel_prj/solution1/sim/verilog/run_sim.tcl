...
if {[file isfile gray_kernel.autotvin.dat]} {
	file delete -force gray_kernel.autotvin.dat
}

if {[file isfile gray_kernel.autotvout.dat]} {
	file delete -force gray_kernel.autotvout.dat
}
