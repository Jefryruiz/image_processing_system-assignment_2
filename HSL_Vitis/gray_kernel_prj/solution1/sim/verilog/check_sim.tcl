...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.gray_kernel.autotvin_gmem.dat"
         "c.gray_kernel.autotvin_in_r.dat"
         "c.gray_kernel.autotvin_out_r.dat"
         "c.gray_kernel.autotvin_num_pixels.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.gray_kernel.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
