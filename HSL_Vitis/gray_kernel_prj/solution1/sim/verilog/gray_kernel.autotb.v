...
`define AUTOTB_DUT      gray_kernel
`define AUTOTB_DUT_INST AESL_inst_gray_kernel
`define AUTOTB_TOP      apatb_gray_kernel_top
`define AUTOTB_LAT_RESULT_FILE "gray_kernel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gray_kernel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gray_kernel_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.gray_kernel.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.gray_kernel.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.gray_kernel.autotvin_out_r.dat"
`define AUTOTB_TVIN_num_pixels  "../tv/cdatafile/c.gray_kernel.autotvin_num_pixels.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.gray_kernel.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "../tv/rtldatafile/rtl.gray_kernel.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.gray_kernel.autotvin_out_r.dat"
`define AUTOTB_TVIN_num_pixels_out_wrapc  "../tv/rtldatafile/rtl.gray_kernel.autotvin_num_pixels.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.gray_kernel.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.gray_kernel.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 8294400;
