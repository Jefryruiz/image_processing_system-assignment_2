...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jezuniga/tools/Xilinx/Vitis_HLS/2024.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gray_kernel.autotvin.dat"
	set constFileTvOut       "gray_kernel.autotvout.dat"
	set constFileHdlTvIn     "gray_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "gray_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
