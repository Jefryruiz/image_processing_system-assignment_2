...
always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        out_r_c_write_local = 1'b1;
    end else begin
        out_r_c_write_local = 1'b0;
    end
end
...
assign out_r_c_write = out_r_c_write_local;

assign start_out = real_start;

endmodule //gray_kernel_entry_proc
